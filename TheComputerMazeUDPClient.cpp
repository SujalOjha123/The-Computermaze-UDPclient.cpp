...
#define STUDENT_NUMBER		"2300098"
#define STUDENT_FIRSTNAME	"Sujal"
#define STUDENT_FAMILYNAME	"Ojha"
...
int known_keys[KNOWN_KEYS] = { 0xC75F, 0x469D, 0x49CD, 0xE333,
							  0x12FC, 0x6BA3, 0x395D, 0x88DE,
							  0x9D58, 0x497E, 0x49CD, 0x88DE,
							  0x19F4, 0x89F3, 0x58B8 };
...
{
	int return_value = NO_MOVE; //default value isn't very good
	int i;
...
void yourMove()
{
	...
	if (move == NO_MOVE) move = pickupStuff();// Check items and place the best of them in the backpack
